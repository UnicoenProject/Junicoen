...
class Java8MapperProgramTest extends MapperTest {
	...
	def void parseCPProgram() {
		...
		val node137 = new UniIdent
		node137.name = node136
		
		val node138 = "next"
		
		val node139 = "iterator"
		...
		val node142 = new UniMethodCall
		node142.methodName = node139
		node142.receiver = node141
		
		val node143 = new UniMethodCall
		node143.methodName = node138
		node143.receiver = node142
		
		val node144 = new UniBinOp
		node144.operator = node135
		node144.right = node137
		node144.left = node143
		
		val node145 = " "
		
		val node146 = new UniStringLiteral
		node146.value = node145
		
		val node147 = #[node146 as UniExpr]
		...
		val node151 = new UniIdent
		node151.name = node150
		
		val node152 = new UniFieldAccess
		node152.fieldName = node149
		node152.receiver = node151
		
		val node153 = new UniMethodCall
		node153.args = node147
		node153.methodName = node148
		node153.receiver = node152
		
		val node154 = #[node153 as UniExpr]
		
		val node155 = new UniBlock
		node155.body = node154
		
		val node156 = new UniIf
		node156.cond = node144
		node156.trueStatement = node155
		
		val node157 = "i"
		
		val node158 = new UniIdent
		node158.name = node157
		
		val node159 = #[node158 as UniExpr]
		...
		val node163 = new UniIdent
		node163.name = node162
		
		val node164 = new UniFieldAccess
		node164.fieldName = node161
		node164.receiver = node163
		
		val node165 = new UniMethodCall
		node165.args = node159
		node165.methodName = node160
		node165.receiver = node164
		
		val node166 = #[node156 as UniExpr, node165 as UniExpr]
		
		val node167 = new UniBlock
		node167.body = node166
		
		val node168 = new UniIf
		node168.cond = node123
		node168.trueStatement = node134
		node168.falseStatement = node167
		...
		val node172 = new UniIdent
		node172.name = node171
		
		val node173 = new UniFieldAccess
		node173.fieldName = node170
		node173.receiver = node172
		
		val node174 = new UniMethodCall
		node174.methodName = node169
		node174.receiver = node173
		
		val node175 = "close"
		
		val node176 = "sc"
		
		val node177 = new UniIdent
		node177.name = node176
		
		val node178 = new UniMethodCall
		node178.methodName = node175
		node178.receiver = node177
		
		val node179 = #[node22 as UniExpr, node26 as UniExpr, node33 as UniExpr, node38 as UniExpr, node65 as UniExpr, node72 as UniExpr, node77 as UniExpr, node119 as UniExpr, node168 as UniExpr, node174 as UniExpr, node178 as UniExpr]
		
		val node180 = new UniBlock
		node180.body = node179
		
		val node181 = new UniMethodDec
		node181.args = node7
		node181.methodName = node8
		node181.modifiers = node11
		node181.returnType = node12
		node181.block = node180
		
		val node182 = #[node181 as UniMemberDec]
		
		val node183 = new UniClassDec
		node183.className = node1
		node183.modifiers = node3
		node183.members = node182
		
		node183.evaluate(actual)
	}
