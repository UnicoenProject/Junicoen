...
public class CParser extends Parser {
	...
	public static final int T__0 = 1, T__1 = 2, T__2 = 3, T__3 = 4, T__4 = 5,
			...
			Identifier = 37, IdentifierNondigit = 38, Nondigit = 39,
			Digit = 40, Constant = 41, IntegerConstant = 42,
			DecimalConstant = 43, NonzeroDigit = 44;
	public static final int RULE_compilationUnit = 0, RULE_translationUnit = 1,
			...
			RULE_blockItemList = 10, RULE_blockItem = 11,
			RULE_declaration = 12, RULE_declarationWithValue = 13,
			RULE_declarationWithoutValue = 14, RULE_initDeclaratorList = 15,
			RULE_initDeclarator = 16, RULE_initializer = 17,
			RULE_assignmentExpression = 18, RULE_unaryExpression = 19,
			RULE_postfixExpression = 20, RULE_primaryExpression = 21,
			RULE_expression = 22, RULE_assignmentOperator = 23,
			RULE_castExpression = 24, RULE_multiplicativeExpression = 25,
			RULE_additiveExpression = 26, RULE_shiftExpression = 27,
			RULE_relationalExpression = 28, RULE_equalityExpression = 29,
			RULE_andExpression = 30, RULE_exclusiveOrExpression = 31,
			RULE_inclusiveOrExpression = 32, RULE_logicalAndExpression = 33,
			RULE_logicalOrExpression = 34, RULE_conditionalExpression = 35;
	public static final String[] ruleNames = { "compilationUnit",
			...
			"blockItemList", "blockItem", "declaration",
			...
			"primaryExpression", "expression", "assignmentOperator",
	...
	private static final String[] _SYMBOLIC_NAMES = { null, null, null, null,
			...
			"Constant", "IntegerConstant", "DecimalConstant", "NonzeroDigit" };
	...
	public static class DeclarationWithoutValueContext extends
			ParserRuleContext {
	...
	public final AssignmentOperatorContext assignmentOperator()
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(171);
				_la = _input.LA(1);
				if (!((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__4)
						| (1L << T__6) | (1L << T__7) | (1L << T__8)
						| (1L << T__9) | (1L << T__10) | (1L << T__11)
						| (1L << T__12) | (1L << T__13) | (1L << T__14) | (1L << T__15))) != 0))) {
					_errHandler.recoverInline(this);
				} else {
					consume();
				}
