 ...
 */
public class CBaseVisitor<T> extends AbstractParseTreeVisitor<T>
		implements CVisitor<T> {
	/**
	 * {@inheritDoc}
	 *
	 * <p>
	 ...
	 */
	@Override
	public T visitDeclarationSpecifiers(
			CParser.DeclarationSpecifiersContext ctx) {
		return visitChildren(ctx);
	}
	 ...
	 */
	@Override
	public T visitDeclarationSpecifier(
	 ...
	 */
	@Override
	public T visitDeclarationWithValue(
			CParser.DeclarationWithValueContext ctx) {
		return visitChildren(ctx);
	}
	...
	public T visitAssignmentExpression(
			CParser.AssignmentExpressionContext ctx) {
		return visitChildren(ctx);
	}
	...
	public T visitRelationalExpression(
			CParser.RelationalExpressionContext ctx) {
		return visitChildren(ctx);
	}
	...
	public T visitExclusiveOrExpression(
			CParser.ExclusiveOrExpressionContext ctx) {
		return visitChildren(ctx);
	}
	...
	public T visitInclusiveOrExpression(
			CParser.InclusiveOrExpressionContext ctx) {
		return visitChildren(ctx);
	}
	...
	public T visitLogicalAndExpression(
			CParser.LogicalAndExpressionContext ctx) {
		return visitChildren(ctx);
	}
	...
	public T visitConditionalExpression(
			CParser.ConditionalExpressionContext ctx) {
		return visitChildren(ctx);
	}
}