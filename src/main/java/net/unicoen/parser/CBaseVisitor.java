...
/**
 * This class provides an empty implementation of {@link CVisitor}, which can be
 ...
 */
public class CBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements
		CVisitor<T> {
	/**
	 * {@inheritDoc}
	 *
	 ...
	 */
	@Override
	public T visitDeclarationWithValue(CParser.DeclarationWithValueContext ctx) {
		return visitChildren(ctx);
	}
	 ...
	 */
	@Override
	public T visitDeclarationWithoutValue(
			CParser.DeclarationWithoutValueContext ctx) {
		return visitChildren(ctx);
	}
