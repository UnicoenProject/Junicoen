// Generated from ExtendedExpression.g4 by ANTLR 4.5.1
...
public class ExtendedExpressionParser extends Parser {
	...
	public static final int LEFTPAREN = 1, RIGHTPAREN = 2, ZERO = 3,
			NONZERODIGIT = 4, ADD = 5, SUB = 6, MUL = 7, DIV = 8, DOT = 9,
			LARGER = 10, LARGEROREQUALS = 11, EQUALS = 12, SMALLEROREQUALS = 13,
			SMALLER = 14, IF = 15, ELSE = 16, LEFTBRACE = 17, RIGHTBRACE = 18,
			ID = 19, SEMICOLON = 20, CLASS = 21, VOID = 22, EQUAL = 23,
			INT = 24, DOUBLE = 25, PUBLIC = 26, PRIVATE = 27, ABSTRACT = 28,
			PROTECTED = 29, PACKAGE = 30, STATIC = 31, FINAL = 32, COMMA = 33,
			WHILE = 34, WS = 35;
	public static final int RULE_program = 0, RULE_classModifiers = 1,
			RULE_classVisibility = 2, RULE_abs = 3, RULE_stat = 4,
			RULE_methodDeclaration = 5, RULE_methodModifiers = 6, RULE_fin = 7,
			RULE_methodVisibility = 8, RULE_methodArguments = 9,
			RULE_methodArgument = 10, RULE_methodBody = 11, RULE_name = 12,
			RULE_type = 13, RULE_statement = 14, RULE_variableDeclaration = 15,
			RULE_ifStatement = 16, RULE_whileStatement = 17,
			RULE_expression = 18, RULE_compareExp = 19, RULE_compareOp = 20,
			RULE_normalExp = 21, RULE_term = 22, RULE_factor = 23,
			RULE_number = 24, RULE_integer = 25, RULE_decimal = 26,
			RULE_mulDivOp = 27, RULE_addSubOp = 28, RULE_digit = 29;
	public static final String[] ruleNames = { "program", "classModifiers",
			"classVisibility", "abs", "stat", "methodDeclaration",
			"methodModifiers", "fin", "methodVisibility", "methodArguments",
			"methodArgument", "methodBody", "name", "type", "statement",
			"variableDeclaration", "ifStatement", "whileStatement",
			"expression", "compareExp", "compareOp", "normalExp", "term",
			"factor", "number", "integer", "decimal", "mulDivOp", "addSubOp",
			"digit" };

	private static final String[] _LITERAL_NAMES = { null, "'('", "')'", "'0'",
			null, "'+'", "'-'", "'*'", "'/'", "'.'", "'>'", "'>='", "'=='",
			"'<='", "'<'", "'if'", "'else'", "'{'", "'}'", null, "';'",
			"'class'", "'void'", "'='", "'int'", "'double'", "'public'",
			"'private'", "'abstract'", "'protected'", "'package'", "'static'",
			"'final'", "','", "'while'" };
	private static final String[] _SYMBOLIC_NAMES = { null, "LEFTPAREN",
			"RIGHTPAREN", "ZERO", "NONZERODIGIT", "ADD", "SUB", "MUL", "DIV",
			"DOT", "LARGER", "LARGEROREQUALS", "EQUALS", "SMALLEROREQUALS",
			"SMALLER", "IF", "ELSE", "LEFTBRACE", "RIGHTBRACE", "ID",
			"SEMICOLON", "CLASS", "VOID", "EQUAL", "INT", "DOUBLE", "PUBLIC",
			"PRIVATE", "ABSTRACT", "PROTECTED", "PACKAGE", "STATIC", "FINAL",
			"COMMA", "WHILE", "WS" };
	...
	public static class ProgramContext extends ParserRuleContext {
		...
		public TerminalNode CLASS() {
			return getToken(ExtendedExpressionParser.CLASS, 0);
		}
		...
		public TerminalNode LEFTBRACE() {
			return getToken(ExtendedExpressionParser.LEFTBRACE, 0);
		}

		public TerminalNode RIGHTBRACE() {
			return getToken(ExtendedExpressionParser.RIGHTBRACE, 0);
		}

		public TerminalNode EOF() {
			return getToken(ExtendedExpressionParser.EOF, 0);
		}
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof ExtendedExpressionVisitor)
				return ((ExtendedExpressionVisitor<? extends T>) visitor)
						.visitProgram(this);
			else
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				_la = _input.LA(1);
				while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << VOID)
						| (1L << INT) | (1L << DOUBLE) | (1L << PUBLIC)
						| (1L << PRIVATE) | (1L << ABSTRACT) | (1L << PROTECTED)
						| (1L << PACKAGE) | (1L << STATIC)
						| (1L << FINAL))) != 0)) {
					{
						{
							setState(64);
	...
	public static class ClassModifiersContext extends ParserRuleContext {
		...
		public ClassModifiersContext(ParserRuleContext parent,
				int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof ExtendedExpressionVisitor)
				return ((ExtendedExpressionVisitor<? extends T>) visitor)
						.visitClassModifiers(this);
			else
				return visitor.visitChildren(this);
		}
	}

	public final ClassModifiersContext classModifiers()
			throws RecognitionException {
		ClassModifiersContext _localctx = new ClassModifiersContext(_ctx,
				getState());
	...
	public static class ClassVisibilityContext extends ParserRuleContext {
		public TerminalNode PUBLIC() {
			return getToken(ExtendedExpressionParser.PUBLIC, 0);
		}

		public TerminalNode PRIVATE() {
			return getToken(ExtendedExpressionParser.PRIVATE, 0);
		}

		public ClassVisibilityContext(ParserRuleContext parent,
				int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof ExtendedExpressionVisitor)
				return ((ExtendedExpressionVisitor<? extends T>) visitor)
						.visitClassVisibility(this);
			else
				return visitor.visitChildren(this);
		}
	}

	public final ClassVisibilityContext classVisibility()
			throws RecognitionException {
		ClassVisibilityContext _localctx = new ClassVisibilityContext(_ctx,
				getState());
	...
	public static class AbsContext extends ParserRuleContext {
		public TerminalNode ABSTRACT() {
			return getToken(ExtendedExpressionParser.ABSTRACT, 0);
		}
	...
	public static class StatContext extends ParserRuleContext {
		public TerminalNode STATIC() {
			return getToken(ExtendedExpressionParser.STATIC, 0);
		}
	...
	public static class MethodDeclarationContext extends ParserRuleContext {
		...
		public TerminalNode LEFTPAREN() {
			return getToken(ExtendedExpressionParser.LEFTPAREN, 0);
		}

		public TerminalNode RIGHTPAREN() {
			return getToken(ExtendedExpressionParser.RIGHTPAREN, 0);
		}
	...
	public static class MethodModifiersContext extends ParserRuleContext {
		...
		public MethodModifiersContext(ParserRuleContext parent,
				int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof ExtendedExpressionVisitor)
				return ((ExtendedExpressionVisitor<? extends T>) visitor)
						.visitMethodModifiers(this);
			else
				return visitor.visitChildren(this);
		}
	}

	public final MethodModifiersContext methodModifiers()
			throws RecognitionException {
		MethodModifiersContext _localctx = new MethodModifiersContext(_ctx,
				getState());
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0
						&& ((1L << _la) & ((1L << PUBLIC) | (1L << PRIVATE)
								| (1L << PROTECTED) | (1L << PACKAGE))) != 0)) {
					{
						setState(98);
						methodVisibility();
					}
	...
	public static class FinContext extends ParserRuleContext {
		public TerminalNode FINAL() {
			return getToken(ExtendedExpressionParser.FINAL, 0);
		}
	...
	public static class MethodVisibilityContext extends ParserRuleContext {
		...
		public TerminalNode PROTECTED() {
			return getToken(ExtendedExpressionParser.PROTECTED, 0);
		}

		public TerminalNode PACKAGE() {
			return getToken(ExtendedExpressionParser.PACKAGE, 0);
		}
		...
		public MethodVisibilityContext(ParserRuleContext parent,
				int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof ExtendedExpressionVisitor)
				return ((ExtendedExpressionVisitor<? extends T>) visitor)
						.visitMethodVisibility(this);
			else
				return visitor.visitChildren(this);
		}
	}

	public final MethodVisibilityContext methodVisibility()
			throws RecognitionException {
		MethodVisibilityContext _localctx = new MethodVisibilityContext(_ctx,
				getState());
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				if (!((((_la) & ~0x3f) == 0 && ((1L << _la)
						& ((1L << PUBLIC) | (1L << PRIVATE) | (1L << PROTECTED)
								| (1L << PACKAGE))) != 0))) {
					_errHandler.recoverInline(this);
				} else {
					consume();
	...
	public static class MethodArgumentsContext extends ParserRuleContext {
		...
		public List<TerminalNode> COMMA() {
			return getTokens(ExtendedExpressionParser.COMMA);
		}
		...
		public MethodArgumentsContext(ParserRuleContext parent,
				int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof ExtendedExpressionVisitor)
				return ((ExtendedExpressionVisitor<? extends T>) visitor)
						.visitMethodArguments(this);
			else
				return visitor.visitChildren(this);
		}
	}

	public final MethodArgumentsContext methodArguments()
			throws RecognitionException {
		MethodArgumentsContext _localctx = new MethodArgumentsContext(_ctx,
				getState());
	...
	public static class MethodArgumentContext extends ParserRuleContext {
		...
		public MethodArgumentContext(ParserRuleContext parent,
				int invokingState) {
			super(parent, invokingState);
		}
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof ExtendedExpressionVisitor)
				return ((ExtendedExpressionVisitor<? extends T>) visitor)
						.visitMethodArgument(this);
			else
				return visitor.visitChildren(this);
		}
	}

	public final MethodArgumentContext methodArgument()
			throws RecognitionException {
		MethodArgumentContext _localctx = new MethodArgumentContext(_ctx,
				getState());
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				while ((((_la) & ~0x3f) == 0 && ((1L << _la)
						& ((1L << IF) | (1L << VOID) | (1L << INT)
								| (1L << DOUBLE) | (1L << WHILE))) != 0)) {
					{
						{
							setState(126);
							statement();
	...
	public static class NameContext extends ParserRuleContext {
		public List<TerminalNode> ID() {
			return getTokens(ExtendedExpressionParser.ID);
		}
	...
	public static class TypeContext extends ParserRuleContext {
		public TerminalNode VOID() {
			return getToken(ExtendedExpressionParser.VOID, 0);
		}

		public TerminalNode INT() {
			return getToken(ExtendedExpressionParser.INT, 0);
		}

		public TerminalNode DOUBLE() {
			return getToken(ExtendedExpressionParser.DOUBLE, 0);
		}
	...
	public static class VariableDeclarationContext extends ParserRuleContext {
		...
		public TerminalNode EQUAL() {
			return getToken(ExtendedExpressionParser.EQUAL, 0);
		}
		...
		public TerminalNode SEMICOLON() {
			return getToken(ExtendedExpressionParser.SEMICOLON, 0);
		}
	...
	public static class IfStatementContext extends ParserRuleContext {
		public TerminalNode IF() {
			return getToken(ExtendedExpressionParser.IF, 0);
		}
		...
		public List<TerminalNode> LEFTBRACE() {
			return getTokens(ExtendedExpressionParser.LEFTBRACE);
		}
		...
		public List<TerminalNode> RIGHTBRACE() {
			return getTokens(ExtendedExpressionParser.RIGHTBRACE);
		}
		...
		public TerminalNode ELSE() {
			return getToken(ExtendedExpressionParser.ELSE, 0);
		}
	...
	public static class WhileStatementContext extends ParserRuleContext {
		public TerminalNode WHILE() {
			return getToken(ExtendedExpressionParser.WHILE, 0);
		}
	...
	public static class CompareOpContext extends ParserRuleContext {
		public TerminalNode LARGER() {
			return getToken(ExtendedExpressionParser.LARGER, 0);
		}

		public TerminalNode LARGEROREQUALS() {
			return getToken(ExtendedExpressionParser.LARGEROREQUALS, 0);
		}

		public TerminalNode EQUALS() {
			return getToken(ExtendedExpressionParser.EQUALS, 0);
		}

		public TerminalNode SMALLEROREQUALS() {
			return getToken(ExtendedExpressionParser.SMALLEROREQUALS, 0);
		}

		public TerminalNode SMALLER() {
			return getToken(ExtendedExpressionParser.SMALLER, 0);
		}
	...
	public final CompareOpContext compareOp() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(191);
				_la = _input.LA(1);
				if (!((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << LARGER)
						| (1L << LARGEROREQUALS) | (1L << EQUALS)
						| (1L << SMALLEROREQUALS) | (1L << SMALLER))) != 0))) {
					_errHandler.recoverInline(this);
				} else {
					consume();
				}
	...
	public static class IntegerContext extends ParserRuleContext {
		public TerminalNode ZERO() {
			return getToken(ExtendedExpressionParser.ZERO, 0);
		}

		public TerminalNode NONZERODIGIT() {
			return getToken(ExtendedExpressionParser.NONZERODIGIT, 0);
		}
	...
	public static class DecimalContext extends ParserRuleContext {
		...
		public TerminalNode DOT() {
			return getToken(ExtendedExpressionParser.DOT, 0);
		}
	...
	public static class MulDivOpContext extends ParserRuleContext {
		public TerminalNode MUL() {
			return getToken(ExtendedExpressionParser.MUL, 0);
		}

		public TerminalNode DIV() {
			return getToken(ExtendedExpressionParser.DIV, 0);
		}
	...
	public static class AddSubOpContext extends ParserRuleContext {
		public TerminalNode ADD() {
			return getToken(ExtendedExpressionParser.ADD, 0);
		}

		public TerminalNode SUB() {
			return getToken(ExtendedExpressionParser.SUB, 0);
		}
	...
	public static final String _serializedATN = "\3\u0430\ud6d1\u8206\uad2d\u4417\uaef1\u8d80\uaadd\3%\u0109\4\2\t\2\4"
