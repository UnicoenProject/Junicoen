...
public class ExtendedExpressionParser extends Parser {
	...
	public static final int LEFTPAREN = 1, RIGHTPAREN = 2, ZERO = 3,
			...
			LARGER = 10, LARGEROREQUALS = 11, EQUALS = 12,
			SMALLEROREQUALS = 13, SMALLER = 14, IF = 15, ELSE = 16,
			LEFTBRACE = 17, RIGHTBRACE = 18, ID = 19, SEMICOLON = 20,
			CLASS = 21, VOID = 22, EQUAL = 23, INT = 24, DOUBLE = 25,
			PUBLIC = 26, PRIVATE = 27, ABSTRACT = 28, PROTECTED = 29,
			PACKAGE = 30, STATIC = 31, FINAL = 32, COMMA = 33, WHILE = 34,
			WS = 35;
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << VOID)
						...
						| (1L << PRIVATE) | (1L << ABSTRACT)
						| (1L << PROTECTED) | (1L << PACKAGE) | (1L << STATIC) | (1L << FINAL))) != 0)) {
					{
						{
							setState(64);
							methodDeclaration();
	...
	public final MethodModifiersContext methodModifiers()
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(99);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << PUBLIC)
						| (1L << PRIVATE) | (1L << PROTECTED) | (1L << PACKAGE))) != 0)) {
					{
						setState(98);
						methodVisibility();
					}
	...
	public final MethodBodyContext methodBody() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << IF)
						| (1L << VOID) | (1L << INT) | (1L << DOUBLE) | (1L << WHILE))) != 0)) {
					{
						{
							setState(126);
							statement();
