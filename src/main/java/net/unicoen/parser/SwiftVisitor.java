...
public interface SwiftVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link SwiftParser#class_body_declarations}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitClass_body_declarations(SwiftParser.Class_body_declarationsContext ctx);
	/**
	 * Visit a parse tree produced by {@link SwiftParser#access_level_modifiers}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAccess_level_modifiers(SwiftParser.Access_level_modifiersContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitExplicit_member_expression4(SwiftParser.Explicit_member_expression4Context ctx);
	/**
