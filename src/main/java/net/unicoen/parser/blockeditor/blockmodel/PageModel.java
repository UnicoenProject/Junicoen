...
public class PageModel {
	...
	private static String PAGE_COLOR_TAGNAME = "page-color";
	private static String PAGE_DRAWER_TAGNAME = "page-drawer";
	private static String IN_FULLVIEW_TAGNAME = "page-infullview";
	private static String PAGE_NAME_TAGNAME = "page-name";
	private static String PAGE_WITDH_TAGNAME = "page-width";
