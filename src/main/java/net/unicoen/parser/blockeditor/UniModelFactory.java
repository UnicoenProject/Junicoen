...
public class UniModelFactory {
	...
	public static enum UniBlockNames {
		UNIARG("UniArg"), UNIARRAY("UniArray"), UNIBINOP("UniBinOp"), UNIBLOCK("UniBlock"), UNIBOOLLITERAL("UniBoolLiteral"), UNIBREAK("UniBreak"), UNICLASSDEC("UniClassDec"), UNICONTINUE("UniContinue"), UNIDOUBLELITERAL("UniDoubleLiteral"), UNIEXPR("UniExpr"), UNIFIELDACCESS("UniFieldAccess"), UNIFIELDDEC("UniFieldDec"), UNIFOR("UniFor"), UNIIDENT("UniIdent"), UNIIF("UniIf"), UNIINTLITERAL("UniIntLiteral"), UNILONGLITERAL("UniLongLiteral"), UNIMEMBERDEC("UniMemberDec"), UNIMETHODCALL("UniMethodCall"), UNIMETHODDEC("UniMethodDec"), UNINEW("UniNew"), UNINEWARRAY("UniNewArray"), UNINODE("UniNode"), UNIRETURN("UniReturn"), UNISTRINGLITERAL("UniStringLiteral"), UNITERNARYOP("UniTernaryOp"), UNIUNARYOP("UniUnaryOp"), UNIVARIABLEDEC("UniVariableDec"), UNIWHILE("UniWhile");
