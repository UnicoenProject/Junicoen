...
public class ECMAScriptParser extends Parser {
	...
	public static final int RegularExpressionLiteral = 1, LineTerminator = 2,
			OpenBracket = 3, CloseBracket = 4, OpenParen = 5, CloseParen = 6,
			OpenBrace = 7, CloseBrace = 8, SemiColon = 9, Comma = 10,
			Assign = 11, QuestionMark = 12, Colon = 13, Dot = 14, PlusPlus = 15,
			...
			Equals = 31, NotEquals = 32, IdentityEquals = 33,
			IdentityNotEquals = 34, BitAnd = 35, BitXOr = 36, BitOr = 37,
			And = 38, Or = 39, MultiplyAssign = 40, DivideAssign = 41,
			ModulusAssign = 42, PlusAssign = 43, MinusAssign = 44,
			LeftShiftArithmeticAssign = 45, RightShiftArithmeticAssign = 46,
			RightShiftLogicalAssign = 47, BitAndAssign = 48, BitXorAssign = 49,
			BitOrAssign = 50, NullLiteral = 51, BooleanLiteral = 52,
			DecimalLiteral = 53, HexIntegerLiteral = 54,
			...
			Try = 81, Class = 82, Enum = 83, Extends = 84, Super = 85,
			Const = 86, Export = 87, Import = 88, Implements = 89, Let = 90,
			Private = 91, Public = 92, Interface = 93, Package = 94,
			Protected = 95, Static = 96, Yield = 97, Identifier = 98,
			StringLiteral = 99, WhiteSpaces = 100, MultiLineComment = 101,
			SingleLineComment = 102, UnexpectedCharacter = 103;
	public static final int RULE_program = 0, RULE_sourceElements = 1,
			RULE_sourceElement = 2, RULE_statement = 3, RULE_block = 4,
			RULE_statementList = 5, RULE_variableStatement = 6,
			RULE_variableDeclarationList = 7, RULE_variableDeclaration = 8,
			RULE_initialiser = 9, RULE_emptyStatement = 10,
			...
			RULE_withStatement = 17, RULE_switchStatement = 18,
			RULE_caseBlock = 19, RULE_caseClauses = 20, RULE_caseClause = 21,
			RULE_defaultClause = 22, RULE_labelledStatement = 23,
			RULE_throwStatement = 24, RULE_tryStatement = 25,
			RULE_catchProduction = 26, RULE_finallyProduction = 27,
			...
			RULE_literal = 45, RULE_numericLiteral = 46,
			RULE_identifierName = 47, RULE_reservedWord = 48, RULE_keyword = 49,
			RULE_futureReservedWord = 50, RULE_getter = 51, RULE_setter = 52,
			RULE_eos = 53, RULE_eof = 54;
	public static final String[] ruleNames = { "program", "sourceElements",
			"sourceElement", "statement", "block", "statementList",
			...
			"elementList", "elision", "objectLiteral",
	...
	private static final String[] _SYMBOLIC_NAMES = { null,
			...
			"IdentityEquals", "IdentityNotEquals", "BitAnd", "BitXOr", "BitOr",
	 ...
	 * stream a token of the given {@code type} exists on the {@code HIDDEN}
	 * channel.
	 *
	 * @param type
	 *            the type of the token on the {@code HIDDEN} channel to check.
	 *
	 * @return {@code true} iff on the current index of the parser's token
	 *         stream a token of the given {@code type} exists on the
	 *         {@code HIDDEN} channel.
	 */
	...
	/**
	 * Returns {@code true} iff on the current index of the parser's token
	 * stream a token exists on the {@code HIDDEN} channel which either is a
	 * line terminator, or is a multi line comment that contains a line
	 * terminator.
	 *
	 * @return {@code true} iff on the current index of the parser's token
	 *         stream a token exists on the {@code HIDDEN} channel which either
	 *         is a line terminator, or is a multi line comment that contains a
	 *         line terminator.
	 */
	...
	public static class ProgramContext extends ParserRuleContext {
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof ECMAScriptVisitor)
				return ((ECMAScriptVisitor<? extends T>) visitor)
						.visitProgram(this);
			else
	...
	public static class SourceElementsContext extends ParserRuleContext {
		...
		public SourceElementsContext(ParserRuleContext parent,
				int invokingState) {
			super(parent, invokingState);
		}
	...
	public final SourceElementsContext sourceElements()
		...
		SourceElementsContext _localctx = new SourceElementsContext(_ctx,
				getState());
	...
	public static class SourceElementContext extends ParserRuleContext {
		...
		public SourceElementContext(ParserRuleContext parent,
				int invokingState) {
			super(parent, invokingState);
		}
	...
	public final SourceElementContext sourceElement()
			throws RecognitionException {
		SourceElementContext _localctx = new SourceElementContext(_ctx,
				getState());
	...
	public static class StatementListContext extends ParserRuleContext {
		...
		public StatementListContext(ParserRuleContext parent,
				int invokingState) {
			super(parent, invokingState);
		}
	...
	public final StatementListContext statementList()
			throws RecognitionException {
		StatementListContext _localctx = new StatementListContext(_ctx,
				getState());
	...
	public static class VariableStatementContext extends ParserRuleContext {
		...
		public VariableStatementContext(ParserRuleContext parent,
				int invokingState) {
			super(parent, invokingState);
		}
	...
	public final VariableStatementContext variableStatement()
			throws RecognitionException {
		VariableStatementContext _localctx = new VariableStatementContext(_ctx,
				getState());
	...
	public static class VariableDeclarationListContext
		...
		public VariableDeclarationListContext(ParserRuleContext parent,
				int invokingState) {
			super(parent, invokingState);
		}
	...
	public final VariableDeclarationListContext variableDeclarationList()
			throws RecognitionException {
		VariableDeclarationListContext _localctx = new VariableDeclarationListContext(
				_ctx, getState());
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				if (!((_input.LA(1) != OpenBrace)
						&& (_input.LA(1) != Function)))
					throw new FailedPredicateException(this,
							"(_input.LA(1) != OpenBrace) && (_input.LA(1) != Function)");
				setState(174);
				expressionSequence();
				setState(175);
				eos();
	...
	public static class IterationStatementContext extends ParserRuleContext {
		public IterationStatementContext(ParserRuleContext parent,
				int invokingState) {
			super(parent, invokingState);
		}
	...
	public static class ForVarStatementContext
			extends IterationStatementContext {
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof ECMAScriptVisitor)
				return ((ECMAScriptVisitor<? extends T>) visitor)
						.visitForVarStatement(this);
			else
				return visitor.visitChildren(this);
		}
	}

	public static class ForVarInStatementContext
			extends IterationStatementContext {
		public TerminalNode For() {
			return getToken(ECMAScriptParser.For, 0);
		}
	...
	public static class ForInStatementContext
			extends IterationStatementContext {
		public TerminalNode For() {
			return getToken(ECMAScriptParser.For, 0);
		}
	...
	public final IterationStatementContext iterationStatement()
			throws RecognitionException {
		IterationStatementContext _localctx = new IterationStatementContext(
				_ctx, getState());
		...
		try {
			...
			case 3:
				...
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0
						&& ((1L << _la) & ((1L << RegularExpressionLiteral)
								| (1L << OpenBracket) | (1L << OpenParen)
								| (1L << OpenBrace) | (1L << PlusPlus)
								| (1L << MinusMinus) | (1L << Plus)
								| (1L << Minus) | (1L << BitNot) | (1L << Not)
								| (1L << NullLiteral) | (1L << BooleanLiteral)
								| (1L << DecimalLiteral)
								| (1L << HexIntegerLiteral)
								| (1L << OctalIntegerLiteral) | (1L << Typeof)
								| (1L << New))) != 0)
						|| ((((_la - 67)) & ~0x3f) == 0 && ((1L << (_la - 67))
								& ((1L << (Void - 67)) | (1L << (Function - 67))
										| (1L << (This - 67))
										| (1L << (Delete - 67))
										| (1L << (Identifier - 67))
										| (1L << (StringLiteral
	...
	public static class WithStatementContext extends ParserRuleContext {
		...
		public WithStatementContext(ParserRuleContext parent,
				int invokingState) {
			super(parent, invokingState);
		}
	...
	public final WithStatementContext withStatement()
			throws RecognitionException {
		WithStatementContext _localctx = new WithStatementContext(_ctx,
				getState());
	...
	public static class DefaultClauseContext extends ParserRuleContext {
		...
		public DefaultClauseContext(ParserRuleContext parent,
				int invokingState) {
			super(parent, invokingState);
		}
	...
	public final DefaultClauseContext defaultClause()
			throws RecognitionException {
		DefaultClauseContext _localctx = new DefaultClauseContext(_ctx,
				getState());
	...
	public static class LabelledStatementContext extends ParserRuleContext {
		...
		public LabelledStatementContext(ParserRuleContext parent,
				int invokingState) {
			super(parent, invokingState);
		}
	...
	public final LabelledStatementContext labelledStatement()
			throws RecognitionException {
		LabelledStatementContext _localctx = new LabelledStatementContext(_ctx,
				getState());
	...
	public static class CatchProductionContext extends ParserRuleContext {
		...
		public CatchProductionContext(ParserRuleContext parent,
				int invokingState) {
			super(parent, invokingState);
		}
	...
	public final CatchProductionContext catchProduction()
			throws RecognitionException {
		CatchProductionContext _localctx = new CatchProductionContext(_ctx,
				getState());
	...
	public static class FinallyProductionContext extends ParserRuleContext {
		...
		public FinallyProductionContext(ParserRuleContext parent,
				int invokingState) {
			super(parent, invokingState);
		}
	...
	public final FinallyProductionContext finallyProduction()
			throws RecognitionException {
		FinallyProductionContext _localctx = new FinallyProductionContext(_ctx,
				getState());
	...
	public static class DebuggerStatementContext extends ParserRuleContext {
		...
		public DebuggerStatementContext(ParserRuleContext parent,
				int invokingState) {
			super(parent, invokingState);
		}
	...
	public final DebuggerStatementContext debuggerStatement()
			throws RecognitionException {
		DebuggerStatementContext _localctx = new DebuggerStatementContext(_ctx,
				getState());
	...
	public static class FunctionDeclarationContext extends ParserRuleContext {
		...
		public FunctionDeclarationContext(ParserRuleContext parent,
				int invokingState) {
			super(parent, invokingState);
		}
	...
	public final FunctionDeclarationContext functionDeclaration()
			throws RecognitionException {
		FunctionDeclarationContext _localctx = new FunctionDeclarationContext(
				_ctx, getState());
	...
	public static class FunctionBodyContext extends ParserRuleContext {
		...
		public FunctionBodyContext(ParserRuleContext parent,
				int invokingState) {
			super(parent, invokingState);
		}
	...
	public final FunctionBodyContext functionBody()
			throws RecognitionException {
		FunctionBodyContext _localctx = new FunctionBodyContext(_ctx,
				getState());
	...
	public static class ArrayLiteralContext extends ParserRuleContext {
		...
		public ArrayLiteralContext(ParserRuleContext parent,
				int invokingState) {
			super(parent, invokingState);
		}
	...
	public final ArrayLiteralContext arrayLiteral()
			throws RecognitionException {
		ArrayLiteralContext _localctx = new ArrayLiteralContext(_ctx,
				getState());
	...
	public static class ObjectLiteralContext extends ParserRuleContext {
		...
		public ObjectLiteralContext(ParserRuleContext parent,
				int invokingState) {
			super(parent, invokingState);
		}
	...
	public final ObjectLiteralContext objectLiteral()
			throws RecognitionException {
		ObjectLiteralContext _localctx = new ObjectLiteralContext(_ctx,
				getState());
	...
	public static class PropertyNameAndValueListContext
			extends ParserRuleContext {
		...
		public PropertyNameAndValueListContext(ParserRuleContext parent,
				int invokingState) {
			super(parent, invokingState);
		}
		...
		@Override
		public int getRuleIndex() {
			return RULE_propertyNameAndValueList;
		}
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof ECMAScriptVisitor)
				return ((ECMAScriptVisitor<? extends T>) visitor)
						.visitPropertyNameAndValueList(this);
			else
				return visitor.visitChildren(this);
		}
	}
	...
	public final PropertyNameAndValueListContext propertyNameAndValueList()
			throws RecognitionException {
		PropertyNameAndValueListContext _localctx = new PropertyNameAndValueListContext(
				_ctx, getState());
	...
	public static class PropertyAssignmentContext extends ParserRuleContext {
		public PropertyAssignmentContext(ParserRuleContext parent,
				int invokingState) {
			super(parent, invokingState);
		}
	...
	public static class PropertyExpressionAssignmentContext
		...
		public PropertyExpressionAssignmentContext(
				PropertyAssignmentContext ctx) {
			copyFrom(ctx);
		}
	...
	public static class PropertySetterContext
			extends PropertyAssignmentContext {
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof ECMAScriptVisitor)
				return ((ECMAScriptVisitor<? extends T>) visitor)
						.visitPropertySetter(this);
			else
				return visitor.visitChildren(this);
		}
	}

	public static class PropertyGetterContext
			extends PropertyAssignmentContext {
	...
	public final PropertyAssignmentContext propertyAssignment()
			throws RecognitionException {
		PropertyAssignmentContext _localctx = new PropertyAssignmentContext(
				_ctx, getState());
	...
	public static class PropertyNameContext extends ParserRuleContext {
		...
		public PropertyNameContext(ParserRuleContext parent,
				int invokingState) {
			super(parent, invokingState);
		}
	...
	public final PropertyNameContext propertyName()
			throws RecognitionException {
		PropertyNameContext _localctx = new PropertyNameContext(_ctx,
				getState());
	...
	public static class PropertySetParameterListContext
			extends ParserRuleContext {
		public TerminalNode Identifier() {
			return getToken(ECMAScriptParser.Identifier, 0);
		}

		public PropertySetParameterListContext(ParserRuleContext parent,
				int invokingState) {
			super(parent, invokingState);
		}
		...
		@Override
		public int getRuleIndex() {
			return RULE_propertySetParameterList;
		}
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof ECMAScriptVisitor)
				return ((ECMAScriptVisitor<? extends T>) visitor)
						.visitPropertySetParameterList(this);
			else
				return visitor.visitChildren(this);
		}
	}
	...
	public final PropertySetParameterListContext propertySetParameterList()
			throws RecognitionException {
		PropertySetParameterListContext _localctx = new PropertySetParameterListContext(
				_ctx, getState());
	...
	public static class ExpressionSequenceContext extends ParserRuleContext {
		...
		public ExpressionSequenceContext(ParserRuleContext parent,
				int invokingState) {
			super(parent, invokingState);
		}
	...
	public final ExpressionSequenceContext expressionSequence()
			throws RecognitionException {
		ExpressionSequenceContext _localctx = new ExpressionSequenceContext(
				_ctx, getState());
	...
	public static class SingleExpressionContext extends ParserRuleContext {
		public SingleExpressionContext(ParserRuleContext parent,
				int invokingState) {
			super(parent, invokingState);
		}
	...
	public static class TernaryExpressionContext
			extends SingleExpressionContext {
		public List<SingleExpressionContext> singleExpression() {
			return getRuleContexts(SingleExpressionContext.class);
		}
	...
	public static class LogicalAndExpressionContext
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof ECMAScriptVisitor)
				return ((ECMAScriptVisitor<? extends T>) visitor)
						.visitLogicalAndExpression(this);
			else
				return visitor.visitChildren(this);
		}
	}
	...
	public static class ObjectLiteralExpressionContext
			extends SingleExpressionContext {
	...
	public static class InExpressionContext extends SingleExpressionContext {
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof ECMAScriptVisitor)
				return ((ECMAScriptVisitor<? extends T>) visitor)
						.visitInExpression(this);
			else
				return visitor.visitChildren(this);
		}
	}

	public static class LogicalOrExpressionContext
			extends SingleExpressionContext {
		public List<SingleExpressionContext> singleExpression() {
			return getRuleContexts(SingleExpressionContext.class);
		}
	...
	public static class NotExpressionContext extends SingleExpressionContext {
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof ECMAScriptVisitor)
				return ((ECMAScriptVisitor<? extends T>) visitor)
						.visitNotExpression(this);
			else
				return visitor.visitChildren(this);
		}
	}

	public static class PreDecreaseExpressionContext
			extends SingleExpressionContext {
		public SingleExpressionContext singleExpression() {
			return getRuleContext(SingleExpressionContext.class, 0);
		}
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof ECMAScriptVisitor)
				return ((ECMAScriptVisitor<? extends T>) visitor)
						.visitPreDecreaseExpression(this);
			else
				return visitor.visitChildren(this);
		}
	}
	...
	public static class ThisExpressionContext extends SingleExpressionContext {
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof ECMAScriptVisitor)
				return ((ECMAScriptVisitor<? extends T>) visitor)
						.visitThisExpression(this);
			else
				return visitor.visitChildren(this);
		}
	}

	public static class FunctionExpressionContext
			extends SingleExpressionContext {
		public TerminalNode Function() {
			return getToken(ECMAScriptParser.Function, 0);
		}
	...
	public static class UnaryMinusExpressionContext
			extends SingleExpressionContext {
		public SingleExpressionContext singleExpression() {
			return getRuleContext(SingleExpressionContext.class, 0);
		}
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof ECMAScriptVisitor)
				return ((ECMAScriptVisitor<? extends T>) visitor)
						.visitUnaryMinusExpression(this);
			else
				return visitor.visitChildren(this);
		}
	}

	public static class PostDecreaseExpressionContext
			extends SingleExpressionContext {
		public SingleExpressionContext singleExpression() {
			return getRuleContext(SingleExpressionContext.class, 0);
		}
	...
	public static class TypeofExpressionContext
			extends SingleExpressionContext {
	...
	public static class InstanceofExpressionContext
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof ECMAScriptVisitor)
				return ((ECMAScriptVisitor<? extends T>) visitor)
						.visitInstanceofExpression(this);
			else
				return visitor.visitChildren(this);
		}
	}

	public static class UnaryPlusExpressionContext
			extends SingleExpressionContext {
		public SingleExpressionContext singleExpression() {
			return getRuleContext(SingleExpressionContext.class, 0);
		}
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof ECMAScriptVisitor)
				return ((ECMAScriptVisitor<? extends T>) visitor)
						.visitUnaryPlusExpression(this);
			else
				return visitor.visitChildren(this);
		}
	}

	public static class DeleteExpressionContext
			extends SingleExpressionContext {
	...
	public static class BitXOrExpressionContext
			extends SingleExpressionContext {
		public List<SingleExpressionContext> singleExpression() {
			return getRuleContexts(SingleExpressionContext.class);
		}
	...
	public static class BitShiftExpressionContext
			extends SingleExpressionContext {
		public List<SingleExpressionContext> singleExpression() {
			return getRuleContexts(SingleExpressionContext.class);
		}
	...
	public static class BitNotExpressionContext
			extends SingleExpressionContext {
		public SingleExpressionContext singleExpression() {
			return getRuleContext(SingleExpressionContext.class, 0);
		}
	...
	public static class LiteralExpressionContext
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof ECMAScriptVisitor)
				return ((ECMAScriptVisitor<? extends T>) visitor)
						.visitLiteralExpression(this);
			else
				return visitor.visitChildren(this);
		}
	}

	public static class ArrayLiteralExpressionContext
			extends SingleExpressionContext {
	...
	public static class MemberDotExpressionContext
			extends SingleExpressionContext {
		public SingleExpressionContext singleExpression() {
			return getRuleContext(SingleExpressionContext.class, 0);
		}
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof ECMAScriptVisitor)
				return ((ECMAScriptVisitor<? extends T>) visitor)
						.visitMemberDotExpression(this);
			else
				return visitor.visitChildren(this);
		}
	}

	public static class MemberIndexExpressionContext
			extends SingleExpressionContext {
		public SingleExpressionContext singleExpression() {
			return getRuleContext(SingleExpressionContext.class, 0);
		}
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof ECMAScriptVisitor)
				return ((ECMAScriptVisitor<? extends T>) visitor)
						.visitMemberIndexExpression(this);
			else
				return visitor.visitChildren(this);
		}
	}
	...
	public static class IdentifierExpressionContext
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof ECMAScriptVisitor)
				return ((ECMAScriptVisitor<? extends T>) visitor)
						.visitIdentifierExpression(this);
			else
				return visitor.visitChildren(this);
		}
	}

	public static class BitAndExpressionContext
			extends SingleExpressionContext {
		public List<SingleExpressionContext> singleExpression() {
			return getRuleContexts(SingleExpressionContext.class);
		}
	...
	public static class BitOrExpressionContext extends SingleExpressionContext {
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof ECMAScriptVisitor)
				return ((ECMAScriptVisitor<? extends T>) visitor)
						.visitBitOrExpression(this);
			else
				return visitor.visitChildren(this);
		}
	}

	public static class AssignmentOperatorExpressionContext
			extends SingleExpressionContext {
		public SingleExpressionContext singleExpression() {
			return getRuleContext(SingleExpressionContext.class, 0);
		}
		...
		public AssignmentOperatorExpressionContext(
				SingleExpressionContext ctx) {
			copyFrom(ctx);
		}
	...
	private SingleExpressionContext singleExpression(int _p)
		...
		SingleExpressionContext _localctx = new SingleExpressionContext(_ctx,
				_parentState);
		...
		try {
			...
			enterOuterAlt(_localctx, 1);
			{
				...
				case New: {
					...
					singleExpression(0);
					setState(497);
					switch (getInterpreter().adaptivePredict(_input, 45,
							_ctx)) {
					case 1: {
						setState(496);
						arguments();
				...
				while (_alt != 2
					...
					if (_alt == 1) {
						...
						{
							setState(575);
							switch (getInterpreter().adaptivePredict(_input, 47,
									_ctx)) {
							case 1: {
								_localctx = new MultiplicativeExpressionContext(
										new SingleExpressionContext(_parentctx,
												_parentState));
	...
	public final AssignmentOperatorContext assignmentOperator()
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				_la = _input.LA(1);
				if (!((((_la) & ~0x3f) == 0
						&& ((1L << _la) & ((1L << MultiplyAssign)
								| (1L << DivideAssign) | (1L << ModulusAssign)
								| (1L << PlusAssign) | (1L << MinusAssign)
								| (1L << LeftShiftArithmeticAssign)
								| (1L << RightShiftArithmeticAssign)
								| (1L << RightShiftLogicalAssign)
	...
	public static class NumericLiteralContext extends ParserRuleContext {
		...
		public NumericLiteralContext(ParserRuleContext parent,
				int invokingState) {
			super(parent, invokingState);
		}
	...
	public final NumericLiteralContext numericLiteral()
			throws RecognitionException {
		NumericLiteralContext _localctx = new NumericLiteralContext(_ctx,
				getState());
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				_la = _input.LA(1);
				if (!((((_la) & ~0x3f) == 0 && ((1L << _la)
						& ((1L << DecimalLiteral) | (1L << HexIntegerLiteral)
								| (1L << OctalIntegerLiteral))) != 0))) {
					_errHandler.recoverInline(this);
				} else {
					consume();
				}
	...
	public static class IdentifierNameContext extends ParserRuleContext {
		...
		public IdentifierNameContext(ParserRuleContext parent,
				int invokingState) {
			super(parent, invokingState);
		}
	...
	public final IdentifierNameContext identifierName()
			throws RecognitionException {
		IdentifierNameContext _localctx = new IdentifierNameContext(_ctx,
				getState());
	...
	public static class ReservedWordContext extends ParserRuleContext {
		...
		public ReservedWordContext(ParserRuleContext parent,
				int invokingState) {
			super(parent, invokingState);
		}
	...
	public final ReservedWordContext reservedWord()
			throws RecognitionException {
		ReservedWordContext _localctx = new ReservedWordContext(_ctx,
				getState());
	...
	public final KeywordContext keyword() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				_la = _input.LA(1);
				if (!(((((_la - 56)) & ~0x3f) == 0
						&& ((1L << (_la - 56)) & ((1L << (Break - 56))
								| (1L << (Do - 56)) | (1L << (Instanceof - 56))
								| (1L << (Typeof - 56)) | (1L << (Case - 56))
								| (1L << (Else - 56)) | (1L << (New - 56))
								| (1L << (Var - 56)) | (1L << (Catch - 56))
								| (1L << (Finally - 56)) | (1L << (Return - 56))
								| (1L << (Void - 56)) | (1L << (Continue - 56))
								| (1L << (For - 56)) | (1L << (Switch - 56))
								| (1L << (While - 56)) | (1L << (Debugger - 56))
								| (1L << (Function - 56)) | (1L << (This - 56))
								| (1L << (With - 56)) | (1L << (Default - 56))
								| (1L << (If - 56)) | (1L << (Throw - 56))
								| (1L << (Delete - 56)) | (1L << (In - 56))
								| (1L << (Try - 56)))) != 0))) {
					_errHandler.recoverInline(this);
				} else {
					consume();
	...
	public static class FutureReservedWordContext extends ParserRuleContext {
		...
		public FutureReservedWordContext(ParserRuleContext parent,
				int invokingState) {
			super(parent, invokingState);
		}
		...
		@Override
		public int getRuleIndex() {
			return RULE_futureReservedWord;
		}
	...
	public final FutureReservedWordContext futureReservedWord()
			throws RecognitionException {
		FutureReservedWordContext _localctx = new FutureReservedWordContext(
				_ctx, getState());
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				_la = _input.LA(1);
				if (!(((((_la - 82)) & ~0x3f) == 0
						&& ((1L << (_la - 82)) & ((1L << (Class - 82))
								| (1L << (Enum - 82)) | (1L << (Extends - 82))
								| (1L << (Super - 82)) | (1L << (Const - 82))
								| (1L << (Export - 82)) | (1L << (Import - 82))
								| (1L << (Implements - 82)) | (1L << (Let - 82))
								| (1L << (Private - 82)) | (1L << (Public - 82))
								| (1L << (Interface - 82))
								| (1L << (Package - 82))
								| (1L << (Protected - 82))
								| (1L << (Static - 82))
	...
	public final GetterContext getter() throws RecognitionException {
		...
		try {
			...
			{
				setState(601);
				if (!(_input.LT(1).getText().startsWith("get")))
					throw new FailedPredicateException(this,
							"_input.LT(1).getText().startsWith(\"get\")");
				setState(602);
				match(Identifier);
			}
		} catch (RecognitionException re) {
	...
	public final SetterContext setter() throws RecognitionException {
		...
		try {
			...
			{
				setState(604);
				if (!(_input.LT(1).getText().startsWith("set")))
					throw new FailedPredicateException(this,
							"_input.LT(1).getText().startsWith(\"set\")");
				setState(605);
				match(Identifier);
			}
		} catch (RecognitionException re) {
	...
	public boolean sempred(RuleContext _localctx, int ruleIndex,
		...
		switch (ruleIndex) {
		case 11:
			return expressionStatement_sempred(
					(ExpressionStatementContext) _localctx, predIndex);
		case 43:
			return singleExpression_sempred((SingleExpressionContext) _localctx,
					predIndex);
		case 51:
	...
	private boolean expressionStatement_sempred(
			ExpressionStatementContext _localctx, int predIndex) {
		switch (predIndex) {
		case 0:
	...
	private boolean singleExpression_sempred(SingleExpressionContext _localctx,
			int predIndex) {
		switch (predIndex) {
		case 1:
	...
	public static final String _serializedATN = "\3\u0430\ud6d1\u8206\uad2d\u4417\uaef1\u8d80\uaadd\3i\u026a\4\2\t\2\4"
			...
			+ "\65\3\65\3\65\3\66\3\66\3\66\3\67\3\67\3\67\3\67\5\67\u0266\n\67\38\3"
			+ "8\38\2\3X9\2\4\6\b\n\f\16\20\22\24\26\30\32\34\36 \"$&(*,.\60\62\64\66"
			+ "8:<>@BDFHJLNPRTVXZ\\^`bdfhjln\2\r\3\2\27\31\3\2\23\24\3\2\32\34\3\2\35"
			+ " \3\2!$\3\2*\64\5\2\3\3\65\66ee\3\2\679\3\2\65\66\3\2:S\3\2Tc\u029f\2"
			+ "q\3\2\2\2\4v\3\2\2\2\6|\3\2\2\2\b\u008d\3\2\2\2\n\u008f\3\2\2\2\f\u0096"
			+ "\3\2\2\2\16\u009a\3\2\2\2\20\u009e\3\2\2\2\22\u00a6\3\2\2\2\24\u00aa\3"
			+ "\2\2\2\26\u00ad\3\2\2\2\30\u00af\3\2\2\2\32\u00b3\3\2\2\2\34\u00f9\3\2"
			+ "\2\2\36\u00fb\3\2\2\2 \u0101\3\2\2\2\"\u0107\3\2\2\2$\u010d\3\2\2\2&\u0113"
			+ "\3\2\2\2(\u0119\3\2\2\2*\u0126\3\2\2\2,\u012a\3\2\2\2.\u0130\3\2\2\2\60"
			+ "\u0135\3\2\2\2\62\u0139\3\2\2\2\64\u014a\3\2\2\2\66\u014c\3\2\2\28\u0152"
			+ "\3\2\2\2:\u0155\3\2\2\2<\u0158\3\2\2\2>\u0163\3\2\2\2@\u016c\3\2\2\2B"
			+ "\u016e\3\2\2\2D\u017b\3\2\2\2F\u0189\3\2\2\2H\u018d\3\2\2\2J\u0196\3\2"
			+ "\2\2L\u01b1\3\2\2\2N\u01b6\3\2\2\2P\u01b8\3\2\2\2R\u01ba\3\2\2\2T\u01c0"
			+ "\3\2\2\2V\u01c8\3\2\2\2X\u01fe\3\2\2\2Z\u0246\3\2\2\2\\\u024a\3\2\2\2"
			+ "^\u024c\3\2\2\2`\u0250\3\2\2\2b\u0255\3\2\2\2d\u0257\3\2\2\2f\u0259\3"
